    ...
    <div data-grid-columns="2">
            ...
            <div class="box">
                <div class="box__content">
                    <div class="form__group">
                        ...
                        <autocomplete :items="icons" @input="selectIcon"></autocomplete> 
                    </div>
                    ...
                    <div class="form__group">
                        ...
                        <div v-if="errors.first('title')">
                            <div class="form__errors">
                                <p v-text="errors.first('title')"></p>
                            </div>
                        </div>
                    </div>

                    <div class="form__group">
                        <label for="description" class="form__label">Description <span class="form__required">*</span></label>
                        <div class="quill-wrapper">
                            <quill :config="editorConfig" v-model="data.description" name="description" id="description" v-validate="'required'" output="html"></quill>
                        </div>

                        <div v-if="errors.first('description')">
                            <div class="form__errors">
                                <p v-text="errors.first('description')"></p>
                            </div>
                        </div>
                    </div>
        ...
        <aside>
            <div class="box" v-if="data.icon">
                ...
                <div class="box__content">
                    <div class="card">
                        <div class="card__image" v-if="data.icon">
                            <div class="card__icon">
                                <i class="fas" :class="data.icon"></i>
                            </div>
                        </div>
                        <div class="card__body" v-if="data.title">
                            <p><strong class="card__title">{{data.title}}</strong></p>
                            <p v-html="data.description"></p>
                            <p class="card__button card__button--disabled">
    ...
    export default {
        ...
        data() {
            return {
                ...
                hasErrors: false,
                // I HATE THIS BIT  - Can I load from file here???????
        ...
        methods: {
            selectIcon(icon) {
                this.data.icon = `fa-${icon}`
            },
            handleFormSubmit() {
                this.$validator.validate().then(valid => {
                    if (valid) {
                        axios.post(`${window.Bettr.homeUrl}/api/goals`, this.data)
                            .then(({data}) => {
                                window.location.href = route('goals.show', data.slug)
                            })
                            .catch(error => {
                                alert(error)
                            })
